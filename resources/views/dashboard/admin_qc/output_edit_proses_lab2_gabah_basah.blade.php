...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on('click', '#btn_update', function(a) {
            ...
            var lokasi_bongkar = $('#lokasi_bongkar').val();
            ...
            Swal.fire({
                ...
                // console.log(result);
                if (result.value) {
                    if ($('#ka_ks').val() == '' | $('#ka_kg').val() == '' | $('#lokasi_bongkar').val() == '' | $('#berat_sample_awal_ks').val() == '' | $('#berat_sample_awal_kg').val() == '' | $('#berat_sample_akhir_kg').val() == '' | $('#berat_sample_pk').val() == '' | $('#berat_sample_beras').val() == '' | $('#wh').val() == '' | $('#tp').val() == '' | $('#md').val() == '' | $('#keterangan_lab_1').val() == '' | $('#broken_setelah_bongkar').val() == '') {
                        Swal.fire({
                            title: 'Maaf !',
