                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="m_tabs_3_1" role="tabpanel">
                            ...
                            <ul class="nav nav-pills float-right" role="tablist">
                                <li class="nav-item mt-3">
                                    <a class="btn btn-sm btn-secondary btn-outline-hover-secondary active" role="tab" aria-controls="tabs_lab2_1" aria-selected="true" data-toggle="tab" href="#tabs_lab2_1"><i class="flaticon2-list-1"></i>PENGAJUAN APPROVE</a>
                                </li>
                                <li class="nav-item mt-3">
                                    <a class="btn btn-sm btn-secondary btn-outline-hover-success" id="notif_swal_approved" role="tab" aria-controls="tabs_lab2_2" aria-selected="false" data-toggle="tab" href="#tabs_lab2_2"><i class="flaticon2-list-1"></i>APPROVED SUCCESS</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="tabs_lab2_1" role="tabpanel">
                                ...
                                <div class="tab-pane" id="tabs_lab2_2" role="tabpanel">
                                    <table class="table table-bordered" id="data_longgrain_approved" style="table-layout: auto;">
                                        <thead>
                                            <tr>
                                                <th style="text-align: center;width:2%">No</th>
                                                <th style="text-align: center;width:auto">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nama&nbsp;Item&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                        ...
                        <div class="tab-pane" id="m_tabs_3_2" role="tabpanel">
                            ...
                            <ul class="nav nav-pills float-right" role="tablist">
                                <li class="nav-item mt-3">
                                    <a class="btn btn-sm btn-secondary btn-outline-hover-secondary active" role="tab" aria-controls="tabs_lab2_pw_1" aria-selected="true" data-toggle="tab" href="#tabs_lab2_pw_1"><i class="flaticon2-list-1"></i>PENGAJUAN APPROVE</a>
                                </li>
                                <li class="nav-item mt-3">
                                    <a class="btn btn-sm btn-secondary btn-outline-hover-success" id="notif_swal_pw_approved" role="tab" aria-controls="tabs_lab2_pw_2" aria-selected="false" data-toggle="tab" href="#tabs_lab2_pw_2"><i class="flaticon2-list-1"></i>APPROVED SUCCESS</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="tabs_lab2_pw_1" role="tabpanel">
                                ...
                                <div class="tab-pane" id="tabs_lab2_pw_2" role="tabpanel">
                                    <table class="table table-bordered" id="data_pw_approved" style="table-layout: auto;">
                                        <thead>
                                            <tr>
                                                <th style="text-align: center;width:2%">No</th>
                                                <th style="text-align: center;width:auto">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nama&nbsp;Item&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            ...
            var table6 = $('#data_longgrain_approved').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.lab.output_lab2_gb_longgrain_approved_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table7 = $('#data_pw_approved').DataTable({
                "scrollY": true,
                "scrollX": true,
                processing: true,
                language: {
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.lab.output_lab2_gb_pandan_wangi_approved_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
        ...
        $('#filter').click(function() {
            ...
            if (from_date != '' && to_date != '') {
                ...
                $('#data_pw_approved').DataTable().destroy();
                        ...
                        onBeforeOpen: () => {
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    $('#data_longgrain_approved').DataTable().ajax.reload();
                                    $('#data_pw_approved').DataTable().ajax.reload();
                                    Swal.fire({
                                        title: 'Berhasil',
