                ...
                <div class="kt-portlet__body">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 order-lg-1 order-xl-1">
                            ...
                            <input type="hidden" name="lab1_id_data_po_gb" id="lab1_id_data_po_gb" value="{{$data->lab1_id_data_po_gb}}">
                            <input type="hidden" name="lab1_id_penerimaan_po_gb" id="lab1_id_penerimaan_po_gb" value="{{$data->lab1_id_penerimaan_po_gb}}">
                            <input type="hidden" id="lab1_id_bid_user" name="lab1_id_bid_user">
                            <input type="hidden" id="hasil_akhir_tonase" name="hasil_akhir_tonase" value="{{$data->hasil_akhir_tonase}}">
                            ...
                            <input type="hidden" id="antrian" name="antrian" value="{{$data->no_antrian}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8 col-xl-8 col-sm-8">
                                    <input type="text" id="lab1_kode_po_gb" name="lab1_kode_po_gb" class="form-control m-input" readonly value="{{$data->lab1_kode_po_gb}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-sm-3 col-form-label">Plat</label>
                                <div class="col-lg-1 col-xl-1 col-sm-1 col-form-label">
                                    :
                                </div>
                                <div class="col-lg-8 col-xl-8 col-sm-8">
                                    <input type="text" id="lab1_plat_gb" readonly name="lab1_plat_gb" class="form-control m-input" value="{{$data->lab1_plat_gb}}">
                                </div>
                            </div>
                            ...
                            <div class="m-form__group form-group row">
                                ...
                                <div class="col-lg-8 col-xl-8 col-sm-8">
                                    ...
                                    <input type="hidden" step="any" value="0" required name="plan_harga_gb" id="plan_harga_gb" class="form-control m-input">
                                </div>
                            </div>
                            <div class="m-form__group form-group row">
                                ...
                                <div class="col-lg-8 col-xl-8 col-sm-8">
                                    ...
                                    <input readonly type="hidden" step="any" value="0" required name="plan_harga_potongan_gb" id="plan_harga_potongan_gb" class="form-control m-input">

                                </div>
                            </div>
                            <div class="m-form__group form-group row">
                                <label class="col-xl-3 col-lg-3 col-sm-3 col-form-label">Aksi Harga</label>
                                <div class="col-lg-1 col-xl-1 col-sm-1 col-form-label">
                                    :
                                </div>
                                <div class="col-lg-8 col-xl-8 col-sm-8">
                            ...
                            <div class="m-form__group form-group row">
                                ...
                                <div class="col-lg-8 col-xl-8 col-sm-8">
                                    <select class="form-select form-control m-input" name="lokasi_gt" id="lokasi_gt" aria-label="Default select example">
                            ...
                            <div class="m-form__group form-group row">
                                <label class="col-xl-3 col-lg-3 col-sm-3 col-form-label">DTM</label>
                                <div class="col-lg-1 col-xl-1 col-sm-1 col-form-label">
                                    :
                                </div>
                                <div class="col-lg-8 col-xl-8 col-sm-8">
                                    <input type="text" required name="no_dtm" id="no_dtm" required class="form-control m-input" value="{{$data->no_dtm}}">
                                    <span class="btn btn-label-info btn-sm "><i class="flaticon2-information"></i><b> Edit Jika No. DTM Salah</b></span>
                                </div>
                            </div>
                            <div class="m-form__group form-group row">
                                <label class="col-xl-3 col-lg-3 col-sm-3 col-form-label">Suveyor</label>
                                <div class="col-lg-1 col-xl-1 col-sm-1 col-form-label">
                                    :
                                </div>
                                <div class="col-lg-8 col-xl-8 col-sm-8">
                                    <input type="text" required name="surveyor_bongkar" readonly id="surveyor_bongkar" class="form-control m-input" value="{{$data->surveyor_bongkar}}">
                                </div>
                            </div>
                            <div class="m-form__group form-group row">
                                ...
                                <div class="col-lg-8 col-xl-8 col-sm-8">
                                    <input type="text" required name="keterangan_bongkar" readonly id="keterangan_bongkar" class="form-control m-input" value="{{$data->keterangan_bongkar}}">
                                </div>
                            </div>
                            <div class="m-form__group form-group row">
                                <label class="col-xl-3 col-lg-3 col-sm-3 col-form-label">Waktu</label>
                                <div class="col-lg-1 col-xl-1 col-sm-1 col-form-label">
                                    :
                                </div>
                                <div class="col-lg-8 col-xl-8 col-sm-8">
                                    <input type="text" required name="waktu_bongkar" readonly id="waktu_bongkar" class="form-control m-input" value="{{$data->waktu_bongkar}}">
                                </div>
                            </div>
                            <div class="m-form__group form-group row">
                                <label class="col-xl-3 col-lg-3 col-sm-3 col-form-label">Z yang dibawa</label>
                                <div class="col-lg-1 col-xl-1 col-sm-1 col-form-label">
                                    :
                                </div>
                                <div class="col-lg-8 col-xl-8 col-sm-8">
                                    <input type="text" required name="z_yang_dibawa" readonly id="z_yang_dibawa" class="form-control m-input" value="{{$data->z_yang_dibawa}}">
                                </div>
                            </div>
                            <div class="m-form__group form-group row">
                                <label class="col-xl-3 col-lg-3 col-sm-3 col-form-label">Z yang ditolak</label>
                                <div class="col-lg-1 col-xl-1 col-sm-1 col-form-label">
                                    :
                                </div>
                                <div class="col-lg-8 col-xl-8 col-sm-8">
                                    <input type="text" required name="z_yang_ditolak" readonly id="z_yang_ditolak" class="form-control m-input" value="{{$data->z_yang_ditolak}}">
                                </div>
                            </div>
                            <div class="text-center">
                                <button id="btn_save" data-bs-toggle="tooltip" data-placement="top" class="btn btn-sm btn-success m-btn">Simpan</button>
                                <a href="{{route('qc.lab.proses_lab2_gabah_basah')}}" type="button" class="btn btn-sm btn-danger m-btn">Kembali</a>
                            </div>
                            <!-- </form> -->
                        </div>
                        <div class="col-xl-3 col-lg-3 order-lg-1 order-xl-1">
    ...
    $(function() {
        ...
        $(document).on('click', '#btn_save', function(a) {
            ...
            Swal.fire({
                title: 'Konfirmasi',
                icon: 'warning',
                html: '<p>Apakah data yang kamu input sudah benar ?</p><h5>Harga Lab : Rp. ' + formatRupiah(plan_harga_potongan_gb) + '</h5>',
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ route('qc.lab.save_proses_lab2_gb') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    success: function(data) {
                                        if (data == 'success') {
                                            ...
                                            window.location.href = "{{ route('qc.lab.proses_lab2_gabah_basah') }}";
                                        } else {
                                            window.location.href = "{{ route('qc.lab.proses_lab2_gabah_basah') }}";
...
<script>
    ...
    var plan_total_harga_gabah_pertruk = document.getElementById('plan_total_harga_gabah_pertruk');
    ...
    function rumus() {
        ...
        if (
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (record == null || record == '') {
                        ...
                        // console.log("harga Bawah sekarang " + harga_bawah);
                    }
                }
            });
            $.ajax({
            ...
            $('#result_harga_akhir').html("Rp. " + formatRupiah(plan_harga_potongan_gb.value));
