    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table = $('#data_longgrain').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('sourching.data_sourching_onprocess_gb_longgrain_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table2 = $('#data_pw').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('sourching.data_sourching_onprocess_gb_pandan_wangi_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table3 = $('#data_kp').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('sourching.data_sourching_onprocess_gb_ketan_putih_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table4 = $('#datatable1').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('sourching.data_sourching_onprocess_pk_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table5 = $('#data_bulog').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('sourching.data_sourching_onprocess_bulog_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
    ...
    $(function() {
        ...
        $('body').on('click', '#btn_nego_pk', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('sourching.status_nego_pk')}}/" + cek,
                        type: "GET",
                        error: function() {
                            alert('Something is wrong');
                        },
