...
<head>
    ...
    @include('dashboard.user.layouts.css')
    @yield('css')
</head>

<body>
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="border-radius: 15px; width: 30%; height: 30%;">
        <div class="offcanvas-body">
            <h6>Profile</h6>
            <ul class="list-group list-group-flush text-right">
                <li class="list-group-item">
                    <a href="{{route('user.account')}}">
                        <span style="color: #262B47;">
                            Profil&nbsp;
                                    ...
                                    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
                                        ...
                                        <div class="kt-notification">
                                            <div class="kt-notification__custom kt-space-between">
                                                <a id="btn_akun" href="{{route('user.account')}}" class="btn btn-label btn-label-brand btn-sm btn-bold">Profile&nbsp;<i class="fa fa-id-badge"></i></a><br>
...
@include('dashboard.user.layouts.js') @yield('js')
