    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <span class="btn-outline btn-sm btn-info mr-3">SUBANG</span>
    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table = $('#datatable').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{route('ap.spv.integrasi_epicor_pk_index')}}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
                ...
                createdRow: function(row, data, index) {
                    ...
                    if (data.name_bid == 'BERAS PECAH KULIT LONG GRAIN') {
            ...
            var table1 = $('#datatable1').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{route('ap.spv.integrasi_epicor_pk1_index')}}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on('click', '.to_show', function() {
            ...
            // console.log(id);
            var url = "{{ route('ap.spv.data_pembelian_show') }}" + "/" + id;
            console.log(url);
            $.ajax({
                type: "GET",
                url: url,
                    ...
                    if (result.value) {
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                Swal.showLoading()
                                $.ajax({
                                    url: "{{ route('ap.spv.kirim_epicor_pk_all')}}",
                                    method: "get",
                                    data: {
                ...
                if (result.value) {
                    Swal.fire({
                        ...
                        onBeforeOpen: () => {
                            Swal.showLoading()
                            $.ajax({
                                url: "{{route('ap.spv.kirim_epicor_gb')}}/" + cek,
                                type: "GET",
                                error: function() {
                                    Swal.fire({
                                        title: 'Gagal!',
        ...
        $('body').on('click', '#btn_approve_pk', function() {
            ...
            Swal.fire({
                ...
                icon: 'warning',
                text: "Pilih 'Yes' Untuk Approve Data Ini",
                showDenyButton: true,
                showCancelButton: true,
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        onBeforeOpen: () => {
                            Swal.showLoading()
                            $.ajax({
                                url: "{{route('ap.spv.approve_receipt_pk')}}/" + cek,
                                type: "GET",
                                error: function() {
                                    Swal.fire({
                                        title: 'Gagal!',
                    ...
                    $.ajax({
                        type: "GET",
                        url: "{{route('ap.spv.not_approve_receipt')}}/" + cek,
                        success: function(response) {
