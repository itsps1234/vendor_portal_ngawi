...
Route::get('/lab/output_lab1_gb_longgrain_approved_index', [QcLab1Controller::class, 'output_lab1_gb_longgrain_approved_index'])->name('lab.output_lab1_gb_longgrain_approved_index');
Route::get('/lab/output_lab1_gb_longgrain_approvedtolak_index', [QcLab1Controller::class, 'output_lab1_gb_longgrain_approvedtolak_index'])->name('lab.output_lab1_gb_longgrain_approvedtolak_index');
