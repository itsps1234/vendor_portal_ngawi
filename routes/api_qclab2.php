...
Route::get('/lab/output_lab2_gb_longgrain_approved_index', [QcLab2Controller::class, 'output_lab2_gb_longgrain_approved_index'])->name('lab.output_lab2_gb_longgrain_approved_index');
