...
Route::prefix('user')->name('user.')->group(function () {
    ...
    Route::middleware(['guest:web', 'PreventBackHistory'])->group(function () {
        ...
        Route::get('/new_login', [UserController::class, 'new_login'])->name('new_login');
        Route::get('/lupa_password', [UserController::class, 'lupa_password'])->name('lupa_password');
        Route::get('/form_otp/{id}', [UserController::class, 'form_otp'])->name('form_otp');
...
Route::prefix('qc')->name('qc.')->group(function () {
    ...
    Route::middleware(['auth:spv', 'PreventBackHistory'])->group(function () {
        ...
        Route::get('/spv/new_output_lab1_gb', [SpvQcAdminController::class, 'new_output_lab1_gb'])->name('spv.new_output_lab1_gb');
        ...
        Route::get('/spv/new_output_lab1_gb_longgrain_index', [SpvQcAdminController::class, 'new_output_lab1_gb_longgrain_index'])->name('spv.new_output_lab1_gb_longgrain_index');
        Route::get('/spv/output_lab1_gb_longgrain_approvedbongkar_index', [SpvQcAdminController::class, 'output_lab1_gb_longgrain_approvedbongkar_index'])->name('spv.output_lab1_gb_longgrain_approvedbongkar_index');
        Route::get('/spv/output_lab1_gb_longgrain_approvedtolak_index', [SpvQcAdminController::class, 'output_lab1_gb_longgrain_approvedtolak_index'])->name('spv.output_lab1_gb_longgrain_approvedtolak_index');
        ...
        Route::get('/spv/new_output_lab2_gb', [SpvQcAdminController::class, 'new_output_lab2_gb'])->name('spv.new_output_lab2_gb');
        ...
        Route::get('/spv/new_output_lab2_gb_longgrain_index', [SpvQcAdminController::class, 'new_output_lab2_gb_longgrain_index'])->name('spv.new_output_lab2_gb_longgrain_index');
        Route::get('/spv/output_lab2_gb_longgrain_approved_index', [SpvQcAdminController::class, 'output_lab2_gb_longgrain_approved_index'])->name('spv.output_lab2_gb_longgrain_approved_index');
...
Route::prefix('ap')->name('ap.')->group(function () {
    ...
    Route::middleware(['auth:spvap', 'PreventBackHistory'])->group(function () {
        ...
        Route::get('/spv/count_diterimaepicor', [AdminSpvApController::class, 'count_diterimaepicor'])->name('spv.count_diterimaepicor');
        Route::get('/getcount_notif_menuall', [AdminSpvApController::class, 'getcount_notif_menuall'])->name('spv.getcount_notif_menuall');
...
Route::prefix('sourching')->name('sourching.')->group(function () {
    ...
    Route::middleware(['auth:sourching', 'PreventBackHistory'])->group(function () {
        ...
        Route::get('/data_sourching_onprocess_bulog_index', [SuperadminController::class, 'data_sourching_onprocess_bulog_index'])->name('data_sourching_onprocess_bulog_index');
